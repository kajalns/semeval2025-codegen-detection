"""
GraphCodeBERT fine-tuning script for SemEval 2026 Task 13 – Subtask A (binary).
"""
...
OUTPUT_DIR = "models/task_a_graphcodebert"
...
def main():
    ...
    print("Starting training for Task A GraphCodeBERT...")
    trainer.train()
    ...
    print("Done. Saved GraphCodeBERT Task A model to:", output_dir)
