"""
UniXcoder fine-tuning script for SemEval 2026 Task 13 – Subtask A (binary).
"""
...
OUTPUT_DIR = "models/task_a_unixcoder"
...
def main():
    ...
    print("Starting training for Task A UniXcoder...")
    trainer.train()
    ...
    print("Done. Saved UniXcoder Task A model to:", output_dir)
